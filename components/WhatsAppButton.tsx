    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
            ...
            <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group flex items-center justify-center w-14 h-14 rounded-full shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl animate-bounce-slow"
            ...
            <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl animate-bounce-slow"
                aria-label="WhatsApp"
            >
...
// Eski isimle de export et (backward compatibility)
export const WhatsAppButton = SocialFloatingButtons;
